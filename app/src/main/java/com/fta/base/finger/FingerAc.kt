...
import com.common.basemodule.ext.yes
import org.jetbrains.anko.toast
import javax.crypto.Cipher
import javax.crypto.SecretKey

class FingerAc : AppCompatActivity() {
...
//        setContentView(R.layout.activity_baseroot)
    ...
    companion object {
        fun startActivity(activity: FingerAc, isSuccess: Boolean) {
            val intent = Intent(activity, FingerAc::class.java)
